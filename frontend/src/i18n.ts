...
const resources = {
  en: {
    translation: {
      ...
      loanOverdue: 'Overdue',
      loanOverdueDays: '{{count}} day overdue',
      loanDueToday: 'Due today',
      loanDueInDays: 'Due in {{count}} day(s)',
      job: 'Job',
      rows: 'Rows',
      reviewed: 'Reviewed',
      uploaded: 'Uploaded',
      ...
      preview: 'Preview',
      processNow: 'Process',
      ocrSourceScan: 'Scanned source',
      ocrPreviewHint: 'Review the scanned page below, then process it to extract the records.',
      ocrScanLocalOnly: 'The scanned page can only be viewed on the local scanning station.',
  ...
  ms: {
    translation: {
      ...
      loanActive: 'Aktif',
      loanReturned: 'Dipulangkan',
      loanOverdue: 'Lewat Tempoh',
      loanOverdueDays: '{{count}} hari lewat tempoh',
      loanDueToday: 'Tamat hari ini',
      loanDueInDays: 'Tamat dalam {{count}} hari',
      job: 'Kerja',
      rows: 'Baris',
      reviewed: 'Disemak',
      ...
      preview: 'Pratonton',
      processNow: 'Proses',
      ocrSourceScan: 'Imbasan sumber',
      ocrPreviewHint: 'Semak halaman yang diimbas di bawah, kemudian proseskan untuk mengekstrak rekod.',
      ocrScanLocalOnly: 'Halaman yang diimbas hanya boleh dilihat di stesen pengimbasan tempatan.',
